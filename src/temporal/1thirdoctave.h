...
*/
aubio_filter_t *new_aubio_filter_1thirdoctave (uint_t samplerate, smpl_t centerfrequency);
...
*/
uint_t aubio_filter_set_1thirdoctave (aubio_filter_t * f, uint_t samplerate, smpl_t centerfrequency);
